...
-- genre
        ...
        -- link genre to movie
        INSERT INTO genres_in_movies(genre_id, movie_id) VALUES ((SELECT id FROM genres WHERE name = genreName), @movieId);
...
-- star
        ...
        -- create star  *TODO*: star ID
            ...
            INSERT INTO stars(id, name, birth_year) VALUES (@starId, starName, 0);
        ...
        -- link star to movie; limit 1 in case more than 1 star is found with same name
          INSERT INTO stars_in_movies(star_id, movie_id) VALUES ((SELECT id FROM stars WHERE name = starName LIMIT 1), @movieId);
